...
export function ServiceCard({ service }: ServiceCardProps) {
  ...
  return (
    <div className="glass-white rounded-xl overflow-hidden shadow-card hover:shadow-card-hover transition-shadow h-full flex flex-col">
      {/* Header */}
      <div className="relative p-6 bg-gradient-to-br from-primary to-primary-dark text-white">
        ...
        {/* Title */}
        <h3 className="text-xl md:text-2xl font-bold mb-3 pr-16">
          {service.title}
        </h3>
